...
import SearchResults from './component/Dashboard/search-results/SearchResults.js'
  ...
  return (
    <div style={{height:'100%'}}>
      ...
      <Switch>
        ...
        <Route exact path='/singledish'><Singledish /></Route>
        <Route exact path='/alldish'><Alldish /></Route>
        <Route exact path='/profile'><Profile /></Route>
        <Route exact path='/search-results'><SearchResults /></Route>
      </Switch>
      </Provider>
      </BrowserRouter>
    </div>
